 ...
 *
 * $Revision: 9441 $
 * $Id: editorconfigurationdlg.cpp 9441 2013-11-09 12:59:13Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/src/editorconfigurationdlg.cpp $
 */
