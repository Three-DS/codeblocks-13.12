 ...
 *
 * $Revision: 9488 $
 * $Id: projectmanagerui.h 9488 2013-12-07 07:02:34Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-13.12/src/src/projectmanagerui.h $
 */
