 ...
 *
 * $Revision: 9418 $
 * $Id: environmentsettingsdlg.cpp 9418 2013-10-23 20:45:12Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/src/environmentsettingsdlg.cpp $
 */
