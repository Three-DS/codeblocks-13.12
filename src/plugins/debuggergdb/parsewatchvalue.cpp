 ...
 *
 * $Revision: 9441 $
 * $Id: parsewatchvalue.cpp 9441 2013-11-09 12:59:13Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/debuggergdb/parsewatchvalue.cpp $
 */
