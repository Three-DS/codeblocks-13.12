 ...
 *
 * $Revision: 8581 $
 * $Id: ccdebuginfo.cpp 8581 2012-11-19 15:09:23Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/codecompletion/parser/ccdebuginfo.cpp $
 */
