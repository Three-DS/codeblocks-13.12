 ...
 *
 * $Revision: 9203 $
 * $Id: coderefactoring.cpp 9203 2013-07-08 23:07:22Z fuscated $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/codecompletion/coderefactoring.cpp $
 */
