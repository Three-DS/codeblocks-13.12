 ...
 *
 * $Revision: 9471 $
 * $Id: cb_koders.cpp 9471 2013-11-30 14:11:48Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-13.12/src/plugins/contrib/cb_koders/cb_koders.cpp $
 */
