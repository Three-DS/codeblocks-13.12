 ...
 *
 * $Revision: 8861 $
 * $Id: IncrementalSearch.cpp 8861 2013-02-26 10:39:37Z jenslody $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/IncrementalSearch/IncrementalSearch.cpp $
 */
