 ...
 *
 * $Revision: 8705 $
 * $Id: headerfixup.cpp 8705 2012-12-23 20:42:29Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/headerfixup/headerfixup.cpp $
 */
