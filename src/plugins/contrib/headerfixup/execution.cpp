 ...
 *
 * $Revision: 8690 $
 * $Id: execution.cpp 8690 2012-12-18 21:27:22Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/headerfixup/execution.cpp $
 */
