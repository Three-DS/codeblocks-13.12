 ...
 *
 * $Revision: 8690 $
 * $Id: protocol.cpp 8690 2012-12-18 21:27:22Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/headerfixup/protocol.cpp $
 */
