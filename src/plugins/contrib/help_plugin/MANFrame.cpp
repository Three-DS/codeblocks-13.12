 ...
 *
 * $Revision: 8579 $
 * $Id: MANFrame.cpp 8579 2012-11-19 00:58:11Z tpetrov $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/help_plugin/MANFrame.cpp $
 */
#include <sdk.h>
