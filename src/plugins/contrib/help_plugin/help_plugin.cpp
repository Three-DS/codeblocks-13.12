 ...
 *
 * $Revision: 9034 $
 * $Id: help_plugin.cpp 9034 2013-05-04 03:02:57Z biplab $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/help_plugin/help_plugin.cpp $
 */
