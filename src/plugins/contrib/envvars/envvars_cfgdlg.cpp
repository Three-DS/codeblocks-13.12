 ...
 *
 * $Revision: 8350 $
 * $Id: envvars_cfgdlg.cpp 8350 2012-09-04 08:05:13Z jenslody $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/envvars/envvars_cfgdlg.cpp $
 */
