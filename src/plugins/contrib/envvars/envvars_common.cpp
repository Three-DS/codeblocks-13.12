 ...
 *
 * $Revision: 9125 $
 * $Id: envvars_common.cpp 9125 2013-05-31 17:14:14Z jenslody $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/envvars/envvars_common.cpp $
 */
