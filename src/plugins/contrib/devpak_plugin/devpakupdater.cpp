 ...
 *
 * $Revision: 7109 $
 * $Id: devpakupdater.cpp 7109 2011-04-15 11:53:16Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/devpak_plugin/devpakupdater.cpp $
 */
