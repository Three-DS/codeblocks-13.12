 ...
 *
 * $Revision: 9329 $
 * $Id: regexdlg.cpp 9329 2013-09-15 23:10:34Z jenslody $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/contrib/regex_testbed/regexdlg.cpp $
 */
