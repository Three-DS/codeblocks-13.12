 ...
 *
 * $Revision: 9264 $
 * $Id: highlighter.cpp 9264 2013-08-17 09:35:46Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/occurrenceshighlighting/highlighter.cpp $
 */
