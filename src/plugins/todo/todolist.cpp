 ...
 *
 * $Revision: 9418 $
 * $Id: todolist.cpp 9418 2013-10-23 20:45:12Z mortenmacfly $
 * $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-xx.yy/src/plugins/todo/todolist.cpp $
 */
