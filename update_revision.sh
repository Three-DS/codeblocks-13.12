...
#
# $Revision: 9491 $
# $Id: update_revision.sh 9491 2013-12-08 15:03:48Z jenslody $
# $HeadURL: http://svn.code.sf.net/p/codeblocks/code/branches/release-13.12/update_revision.sh $
#
...
if [ "x$REV" != "x$OLD_REV" -o ! -r $REV_FILE ]; then
	...
	echo "m4_define([SVN_REVISION], 13.12-$REV)" >> $REV_FILE
